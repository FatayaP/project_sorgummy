...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Map<String, dynamic>> _notifications = [
    ...
    },
    {
      ...
      'detail': 'Kalender pengelolaan mencahat hari ini adalah jadwal pemupukan susulan tahap kedua untuk tanaman sorgum di Blok A (usia 30 HST). Gunakan dosis rekomendasi yang tertera pada modul kelola.',
      'time': 'Kemarin',
      'isUnread': false,
