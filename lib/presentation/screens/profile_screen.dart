...
import 'search_settings_screen.dart'; // Impor Pengaturan Pencarian Baru
                    ...
                    children: [
                      ...
                      _buildMenuSection(
                        ...
                        items: [
                          ...
                          _MenuData(icon: Icons.search_rounded, title: 'Pengaturan Pencarian', destination: const SearchSettingsScreen()),
                        ],
                      ),
                      const SizedBox(height: 24),
                      _buildMenuSection(
