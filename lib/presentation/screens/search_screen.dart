...
import '../../data/helpers/database_helper.dart'; // Impor DatabaseHelper untuk riwayat pencarian
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    ...
    if (widget.query.trim().isNotEmpty) {
      DatabaseHelper.instance.insertSearchHistory(widget.query.trim());
    }
  }
            ...
            child: TextField(
              ...
              onSubmitted: (value) {
                ...
                if (trimmed.isNotEmpty) {
                  DatabaseHelper.instance.insertSearchHistory(trimmed);
                }
              },
